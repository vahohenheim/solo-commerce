...
import ProductActionsComponent from '@/app/product/[id]/_components/product-actions/product-actions';
...
const ProductPage = async ({ params }: { params: { id: string } }) => {
    // TODO: Any cache invalidation is defined here. It's going to be a problem when the product data changed.
        ...
        <div>
            ...
            <div className="mx-auto grid grid-cols-1 pb-16 pt-10 md:grid-cols-5 lg:gap-x-8 lg:pb-24 lg:pt-16">
                ...
                <div className="col-span-2 mt-4 lg:mt-0">
                    ...
                    <ProductActionsComponent productId={product.id} productName={product.title} />
                </div>
            </div>
            <h2 className="mt-4 text-2xl font-bold tracking-tight text-gray-900">Related Products</h2>
            <ProductListComponent removedProducts={[product.id]} category={product.category} limit={4} />
        </div>
    );
};
